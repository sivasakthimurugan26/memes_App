...
import 'package:memes_app/screens/preview_download.dart';
import 'package:provider/provider.dart';

import '../models/cart_card_model.dart';
...
Future<Model> getMemesApi() async {
  final response =
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                      ...
                                      style: ElevatedButton.styleFrom(
                                          backgroundColor: memeCartProvider
                                                  .getMemesIdList!
                                                  .contains(memeId)
